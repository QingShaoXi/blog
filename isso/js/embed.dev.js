...
define('app/i18n/ru',{
    ...
    "comment-hidden": "Скрыт  комментарий\nСкрыто  комментария\nСкрыто  комментариев",
    "date-now": "Только что",
    "date-minute": " минуту назад\n минуты назад\n минут назад",
    "date-hour": " час назад\n часа назад\n часов назад",
    "date-day": " день назад\n дня назад\n дней назад",
    "date-week": " неделю назад\n недели назад\n недель назад",
    "date-month": " месяц назад\n месяца назад\n месяцев назад",
    "date-year": " год назад\n года назад\n лет назад"
});
    ...
    var pluralforms = function(lang) {
        ...
        case "ru":
            return function(msgs, n) {
                if (n % 10 === 1 && n % 100 !== 11) {
                    return msgs[0];
                } else if (n % 10 >= 2 && n % 10 <= 4="" 10="" 100="" &&="" (n="" %="" <="" ||="" n="">= 20)) {
                    return msgs[1];
                } else {
...
define('app/utils',["app/i18n"], function(i18n) {
    ...
    var ago = function(localTime, date) {
        ...
        return secs  <= 45="" &&="" i18n.translate("date-now")="" ||="" secs="" <="90" i18n.pluralize("date-minute",="" 1)="" mins="" mins)="" i18n.pluralize("date-hour",="" hours="" hours)="" i18n.pluralize("date-day",="" days="" days)="" i18n.pluralize("date-week",="" math.floor(days="" 7))="" i18n.pluralize("date-month",="" 30))="" i18n.pluralize("date-year",="" 365.25));="" };="" var="" htmlentity="{" "&":="" "&amp;",="" "<":="" "&lt;",="" "="">": "&gt;",
        '"': '&quot;',
        "'": '&#39;',
        "/": '&#x2F;'
    };
...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define('libjs-jade-runtime',[],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.jade = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){="" 'use="" strict';="" **="" *="" merge="" two="" attribute="" objects="" giving="" precedence="" to="" values="" in="" object="" `b`.="" classes="" are="" special-cased="" allowing="" for="" arrays="" and="" merging="" joining="" appropriately="" resulting="" a="" string.="" @param="" {object}="" b="" @return="" @api="" private="" exports.merge="function" merge(a,="" b)="" {="" if="" (arguments.length="==" 1)="" var="" attrs="a[0];" (var="" i="1;" <="" a.length;="" i++)="" a[i]);="" }="" return="" attrs;="" ac="a['class'];" bc="b['class'];" (ac="" ||="" bc)="" [];="" (!array.isarray(ac))="" (!array.isarray(bc))="" a['class']="ac.concat(bc).filter(nulls);" key="" (key="" !="class" )="" a[key]="b[key];" a;="" };="" filter="" null="" `val`s.="" {*}="" val="" {boolean}="" function="" nulls(val)="" &&="" '';="" join="" array="" as="" classes.="" {string}="" exports.joinclasses="joinClasses;" joinclasses(val)="" (array.isarray(val)="" ?="" val.map(joinclasses)="" :="" (val="" typeof="" 'object')="" object.keys(val).filter(function="" (key)="" val[key];="" })="" [val]).filter(nulls).join('="" ');="" render="" the="" given="" {array}="" {array.<boolean="">} escaped
 * @return {String}
 */
...
buf.push("<div class="\"isso-postbox\""><div class="\"form-wrapper\""><div class="\"textarea-wrapper\""><div contenteditable="\"true\"" class="\"textarea" placeholder\"="">" + (jade.escape(null == (jade_interp = i18n('postbox-text')) ? "" : jade_interp)) + "</div><div class="\"preview\""><div class="\"isso-comment\""><div class="\"text-wrapper\""><div class="\"text\""></div></div></div></div></div><section class="\"auth-section\""><p class="\"input-wrapper\""><input type="\"text\"" name="\"author\""" +="" (jade.attr("placeholder",="" i18n('postbox-author'),="" true,="" false))="" (jade.attr("value",="" author="" !="=" null="" ?="" ''="" (author)="" :="" '',="" "=""></p><p class="\"input-wrapper\""><input type="\"email\"" name="\"email\""" +="" (jade.attr("placeholder",="" i18n('postbox-email'),="" true,="" false))="" (jade.attr("value",="" email="" !="null" ?="" ''="" (email)="" :="" '',="" "=""></p><p class="\"input-wrapper\""><input type="\"text\"" name="\"website\""" +="" (jade.attr("placeholder",="" i18n('postbox-website'),="" true,="" false))="" (jade.attr("value",="" website="" !="null" ?="" ''="" (website)="" :="" '',="" "=""></p><p class="\"post-action\""><input type="\"submit\""" +="" (jade.attr("value",="" i18n('postbox-submit'),="" true,="" false))="" "=""></p><p class="\"post-action\""><input type="\"button\"" name="\"preview\""" +="" (jade.attr("value",="" i18n('postbox-preview'),="" true,="" false))="" "=""></p><p class="\"post-action\""><input type="\"button\"" name="\"edit\""" +="" (jade.attr("value",="" i18n('postbox-edit'),="" true,="" false))="" "=""></p></section></div></div>");}.call(this,"author" in locals_for_with?locals_for_with.author:typeof author!=="undefined"?author:undefined,"email" in locals_for_with?locals_for_with.email:typeof email!=="undefined"?email:undefined,"i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined,"website" in locals_for_with?locals_for_with.website:typeof website!=="undefined"?website:undefined));;return buf.join("");
...
if ( conf.gravatar)
{
buf.push("<div class="\"avatar\""><img" +="" (jade.attr("src",="" ''="" (comment.gravatar_image)="" '',="" true,="" false))="" "=""></img"></div>");
}
if ( conf.avatar)
{
...
{
buf.push("<a" +="" (jade.attr("href",="" ''="" (comment.website)="" '',="" true,="" false))="" "="" rel="\"nofollow\"" class="\"author\"">" + (jade.escape(null == (jade_interp = bool(comment.author) ? comment.author : i18n('comment-anonymous')) ? "" : jade_interp)) + "");
}
else
{
...
buf.push("<span class="\"spacer\"">&bull;</span><a" +="" (jade.attr("href",="" '#isso-'="" (comment.id)="" '',="" true,="" false))="" "="" class="\"permalink\""><time" +="" (jade.attr("title",="" ''="" (humanize(comment.created))="" '',="" true,="" false))="" (jade.attr("datetime",="" (datetime(comment.created))="" "=""><span class="\"note\"">" + (jade.escape(null == (jade_interp = comment.mode == 2 ? i18n('comment-queued') : comment.mode == 4 ? i18n('comment-deleted') : '') ? "" : jade_interp)) + "</span></time"></a"></a"></div><div class="\"text\"">");
if ( comment.mode == 4)
{
buf.push("<p>&nbsp;</p>");
}
...
define('app/lib/identicons',["app/lib/promise", "app/config"], function(Q, config) {
    ...
    var generateIdenticon = function(key, padding, size) {
        ...
        Q.when(key, function(key) {
            ...
            for (var x=0; x<math.ceil(grid 0="" 3="" 2);="" x++)="" {="" for="" (var="" y="0;" y<grid;="" y++)="" if="" (hash.charat(index)="==" "1")="" fill(svg,="" x,="" y,="" padding,="" 8,="" color);="" fill="" right="" sight="" symmetrically="" (x="" <="" math.floor(grid="" 2))="" (grid-1)="" -="" }="" index++;="" });="" return="" svg;="" };="" var="" generateblank="function(height," width)="" blank="parseInt([" 0,="" 1,="" *="" purple:="" ].join(""),="" 2).tostring(16);="" el="generateIdenticon(blank," height,="" width);="" el.setattribute("classname",="" "blank");="" ie10="" does="" not="" support="" classlist="" on="" svg="" elements,="" duh.="" el;="" generate:="" generateidenticon,="" blank:="" define('app="" lib',['require','app="" lib="" editor','app="" identicons'],function="" (require)="" editorify:="" require("app="" editor"),="" identicons:="" identicons")="" isso="" –="" ich="" schrei="" sonst!="" isso',["app="" dom",="" "app="" utils",="" config",="" api",="" jade",="" i18n",="" lib",="" globals"],="" function($,="" utils,="" config,="" api,="" jade,="" i18n,="" lib,="" globals)="" "use="" strict";="" postbox="function(parent)" localstorage="utils.localStorageImpl," "author":="" json.parse(localstorage.getitem("author")),="" "email":="" json.parse(localstorage.getitem("email")),="" "website":="" json.parse(localstorage.getitem("website")),="" "preview":="" ''="" }));="" callback="" success="" (e.g.="" to="" toggle="" the="" reply="" button)="" el.onsuccess="function()" {};="" el.validate="function()" (utils.text($(".textarea",="" this).innerhtml).length="" ||="" $(".textarea",="" this).classlist.contains("placeholder"))="" this).focus();="" false;="" (config["require-email"]="" &&="" $("[name="email" ]",="" this).value.length="" (config["require-author"]="" true;="" email="" is="" optional="" this="" config="" parameter="" set="" (config["require-email"])="" el).setattribute("placeholder",="" el).getattribute("placeholder").replace(="" \(.*\)="" ,="" ""));="" author="" (config["require-author"])="" el).placeholder="$("[name='author']"," el).placeholder.replace(="" "");="" preview="" function="" el).on("click",="" function()="" api.preview(utils.text($(".textarea",="" el).innerhtml)).then(="" function(html)="" $(".preview="" .text",="" el).innerhtml="html;" el.classlist.add('preview-mode');="" edit="" ;="" el.classlist.remove('preview-mode');="" edit);="" $(".preview",="" submit="" form,="" initialize="" fields="" with="" `null`="" and="" reset="" form.="" replied="" a="" comment,="" remove="" form="" completely.="" $("[type="submit]"," edit();="" (!="" el.validate())="" return;="" el).value="" null,="" website="$("[name=website]"," null;="" localstorage.setitem("author",="" json.stringify(author));="" localstorage.setitem("email",="" json.stringify(email));="" localstorage.setitem("website",="" json.stringify(website));="" api.create($("#isso-thread").getattribute("data-isso-id"),="" author:="" author,="" email:="" email,="" website:="" website,="" text:="" utils.text($(".textarea",="" el).innerhtml),="" parent:="" parent="" title:="" $("#isso-thread").getattribute("data-title")="" null="" }).then(function(comment)="" el).blur();="" insert(comment,="" true);="" (parent="" !="=" null)="" el.onsuccess();="" lib.editorify($(".textarea",="" el));="" insert_loader="function(comment," lastcreated)="" entrypoint;="" (comment.id="==" entrypoint="$("#isso-root");" comment.name="null" else="" +="" comment.id="" "=""> .text-wrapper > .isso-follow-up");
    ...
    var insert = function(comment, scrollIntoView) {
        ...
        if (config.vote) {
            ...
            var votes = function (value) {
                ...
                if (voteLevels) {
                    var before = true;
                    for (var index = 0; index <= votelevels.length;="" index++)="" {="" if="" (before="" &&="" (index="">= voteLevels.length || value < voteLevels[index])) {
...
}());</info@posativ.org></=></math.ceil(grid></info@posativ.org></gschier1990@gmail.com></=></=>